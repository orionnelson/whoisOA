...
export function Search() {
  ...
  const countryDisplay = data && data.website ? (
  ...
  <h1>Registrant Organization: {data.website.whois.registrant.organization}</h1>
  ...
  <h1>Registrar Abuse Contact Email: {data.website.whois.registrar.abuseContactEmail}</h1>
  <h1>Registrar Abuse Contact Phone: {data.website.whois.registrar.abuseContactPhone}</h1>
  <h1>Registrar Whois Server: {data.website.whois.registrar.whoisServer}</h1>
  ...
  return (
    <div className="search">
      <div className="search-box">
        ...
        >
          {<a className = "search-btn"><i className="fas fa-search" aria-hidden="true"></i></a>}
